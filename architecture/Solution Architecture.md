...
![Bob and Alice exchange RPIs during an encounter](images/image_0.png)
...
![Bob tests positive and uploads his keys](images/image_1.png)
...
![Alice downloads infected keys and checks if she has a match](images/image_2.png)
...
![Alices phone calculates the risk of the encounter](images/image_3.png)
...
![Finally, Alice is notified that she had a risky encounter](images/image_4.png)
...
![An overview of the entire process flow](images/image_5.png)
...
![Security overview](images/image_6.png)
...
![Lab result flow](images/image_7.png)
...
![High level backend overview](images/image_8.png)

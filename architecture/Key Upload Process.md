...
2) Usability: we should minimize traffic for the user, but only if it doesn't introduce security risks.
...
2. The *server* keeps track of keys it already has and makes sure it doesn't publish keys to the CDN that were already published.
